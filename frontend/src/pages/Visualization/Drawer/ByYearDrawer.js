          ...
          >
            {viewOptions.map((option) => (
              <MenuItem
                key={option.value}
                value={option.value}
                onClick={() => checkIsCriteria(option.value)}
              >
                {option.label}
              </MenuItem>
            ))}
            ...
            <Box sx={{ width: "100%", marginTop: 2, marginBottom: 4 }}>
              ...
              >
                <Button
                  ...
                  onClick={() => changeCriteria("FinalExamDifficulty")}
                >
                ...
                <Button
                  variant="contained"
                  startIcon={<ClassIcon />}
                  onClick={() => changeCriteria("LectureDifficulty")}
                >
                  Lecture Difficulty
                </Button>
                <Button
                  ...
                  onClick={() => changeCriteria("CourseDelivery")}
                >
                ...
                <Button
                  variant="contained"
                  startIcon={<SchoolIcon />}
                  onClick={() => changeCriteria("CourseEntertaining")}
                >
                ...
                <Button
                  variant="contained"
                  startIcon={<SchoolIcon />}
                  onClick={() => changeCriteria("CourseInteractivity")}
                >
                ...
                <Button
                  ...
                  onClick={() => changeCriteria("Workload")}
                >
                  Workload
                </Button>
              </Stack>
            ...
            <Box sx={{ width: "100%", marginTop: 2, marginBottom: 4 }}>
              ...
              >
                {professorList.map((item, index) => (
                  <Button onClick={() => handleProfessorClick(index)}>
                    {item}
                  </Button>
                ))}
              </Stack>
